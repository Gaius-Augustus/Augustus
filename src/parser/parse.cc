// Generated by Bisonc++ V3.01.00 on Wed, 31 May 2017 15:32:17 +0200
...
PI__ const s_productionInfo[] = 
{
     ...
     {270, 1}, // 1: nexus ->  tree
     {270, 9}, // 2: nexus (BEGIN) ->  BEGIN TREE ';' TREE SPECIES '=' tree END ';'
     {270, 11}, // 3: nexus (BEGIN) ->  BEGIN TREE ';' TRANSLATE translationkey TREE SPECIES '=' tree END ';'
     {271, 3}, // 4: translationkey (',') ->  key ',' translationkey
     {271, 2}, // 5: translationkey (';') ->  key ';'
     {272, 2}, // 6: key (NUM) ->  NUM SPECIES
     {273, 2}, // 7: tree (';') ->  subtree ';'
     {274, 1}, // 8: subtree ->  leaf
     {274, 3}, // 9: subtree ('(') ->  '(' branchset ')'
     {274, 3}, // 10: subtree ('(') ->  '(' branchset ANC
     {275, 1}, // 11: leaf (NUM) ->  NUM
     {275, 1}, // 12: leaf (SPECIES) ->  SPECIES
     {276, 1}, // 13: branchset ->  branch
     {276, 3}, // 14: branchset (',') ->  branchset ',' branch
     {277, 3}, // 15: branch (':') ->  subtree ':' DISTANCE
     {277, 3}, // 16: branch (':') ->  subtree ':' NUM
     {278, 1}, // 17: nexus_$ ->  nexus
};
...
SMapVal s_symArr[] =
{
    ...
    SMapVal(264, "ANC"),
    SMapVal(270, "nexus"),
    SMapVal(271, "translationkey"),
    SMapVal(272, "key"),
    SMapVal(273, "tree"),
    SMapVal(274, "subtree"),
    SMapVal(275, "leaf"),
    SMapVal(276, "branchset"),
    SMapVal(277, "branch"),
    SMapVal(278, "nexus_$"),
};
...
#line 106 "grammar"
        {
         ...
         d_vsp__[-1].nodeptr->addChild(temp);
         ptree->push_back(d_vsp__[-1].nodeptr);
         d_val__.nodeptr = d_vsp__[-1].nodeptr;
         }
        break;
