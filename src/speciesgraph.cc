...
void SpeciesGraph::printWeights(){
    cout << "Logistic regression weights to score exons comparatively:" << endl;
    size_t n = Constant::ex_sc.size();

    for (size_t i=0; i<n; i++){
        cout << i << "\t" << Constant::ex_sc[i] << endl;
    }
}
