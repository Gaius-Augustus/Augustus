...
Connection::Connection() : connect_timeout_ms(20000), response_timeout_ms(20000), max_tries(10) {
...
ConnectionHandler::ConnectionHandler(): connect_timeout_ms(2000), response_timeout_ms(20000), max_tries(10) {
