...
<div id="koerper">
  ...
  <div id="linke_spalte">
	 ...
	 <li><a href="http://bioinf.uni-greifswald.de/bioinf/wiki/forum">AUGUSTUS Forum</a></li>
  ...
  <div id="mittel_spalte">
	...
	<td class="contentheading" width="100%">
	  <a href="predictions_for_download.gsp" class="contentpagetitle">Gene Predictions for Download</a>
        </td>
      </tr>
    </table>
<object height="4000px" width="660px" data="http://bioinf.uni-greifswald.de/trainaugustus/training-results/dynamic/predictions_for_download.html"></object>
  </div>
