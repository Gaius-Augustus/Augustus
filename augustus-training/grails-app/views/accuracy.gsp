...
<div id="koerper">
  ...
  <div id="linke_spalte">
     <ul class="menu">
         ...
         <li id="current"><a href="accuracy.gsp"><span>Accuracy</span></a></li>
  ...
  <div id="mittel_spalte">
	...
	<td class="contentheading" width="100%">
	  <a href="accuracy.gsp" class="contentpagetitle">Accuracy of AUGUSTUS</a>
        </td>
      </tr>
    </table>
<object height="4000px" width="660px" data="http://bioinf.uni-greifswald.de/trainaugustus/training-results/dynamic/accuracy.html"></object>
  </div>
