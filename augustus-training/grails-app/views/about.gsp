...
<div id="koerper">
  ...
  <div id="linke_spalte">
     <ul class="menu">
         ...
         <li id="current"><a href="about.gsp"><span>About AUGUSTUS</span></a></li>
  ...
  <div id="mittel_spalte">
	...
	<td class="contentheading" width="100%">
	  <a href="about.gsp" class="contentpagetitle">About AUGUSTUS</a>
        </td>
      </tr>
    </table>
<object height="4000px" width="660px" data="http://bioinf.uni-greifswald.de/trainaugustus/training-results/dynamic/about.html"></object>
  </div>
