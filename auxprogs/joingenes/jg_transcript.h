...
class Transcript{
	...
	pair<unsigned int,unsigned int> boha;		// pred range border happenings at <start/stop> side: 0-no problem, 1-to close, 2-to close but last exon erased
	pair<Transcript*,Transcript*> joinpartner;	// pointer to transcript that was used to fullfill the <start,stop> codon side
	pair<Transcript*,Transcript*> utr_joinpartner;	// pointer to transcript that was used to fullfill the <downstream-UTR,upstream-UTR> codon side
