...
easily, if it is to be applied to a different type of application (see the reference manual below for 
further information). filterBam is written in C++ and makes use of the Bamtools API of 
